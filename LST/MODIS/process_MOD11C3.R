...
hdf_path <- "/home/cseiler/projects/def-cseiler-ab/cseiler/globEarthObs/LST/MODIS/MOD11C3/e4ftl01.cr.usgs.gov/MOLT/MOD11C3.061"
...
terra::writeCDF(x = data, filename = "MOD11C3_128x64.nc", varname = "LST", unit = "K", overwrite=T)
